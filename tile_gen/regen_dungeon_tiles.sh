...
for filename in ../static/map/dungeons/originals/*/*.png ; do
	...
	if [ ! -f ../static/map/dungeons/overrides/$filename/$filename.jpg ]; then
		./gdal2tiles-leaflet/gdal2tiles.py -l -p raster -z 1-4 -w none $original_filename.jpg ../static/map/dungeons/generated/$filename
	else

		./gdal2tiles-leaflet/gdal2tiles.py -l -p raster -z 1-4 -w none ../static/map/dungeons/overrides/$filename/$filename.jpg ../static/map/dungeons/generated/$filename
	fi
	echo $filename
done
